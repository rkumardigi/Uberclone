//export const filterData = [ {name:"iShare",image: require('../../assets/ride.png'), id:"0"},
  //  {name:"iTaxi",image:require("../../assets/uberTime.png"),id:"1"},
    //{name:"iVolunteer",image:require("../../assets/uberAssist.png"),id:"2"},
   // {name:"iReserve",image:require("../../assets/reserve.png"),id:"3"}
  
   //];

   export const filterData = [
        {name: "iShare", image: require('../../assets/ride.png'), id: "0", type: "rideshare"},
        {name: "iTaxi", image: require("../../assets/uberTime.png"), id: "1", type: "taxi"},
        {name: "iVolunteer", image: require("../../assets/uberAssist.png"), id: "2", type: "volunteer"},
        {name: "iReserve", image: require("../../assets/reserve.png"), id: "3", type: "scheduled"}
    ];
...
export const carsAround = [{latitude:-18.112072,longitude:178.573109},
{latitude:-18.012072,longitude:178.5731309},
{latitude:-18.012072,longitude:178.5731309},
{latitude:-18.012072,longitude:178.5731309},
{latitude:-18.012072,longitude:178.5731309},
]